...
func (u *UserServiceFacade) Create(userData map[string]interface{}, roleNames []string) (*models.User, error) {
	if globalUserService == nil {
		return nil, errors.New("user service not found")
	}
	if userService, ok := globalUserService.(interface {
		CreateUser(userData map[string]interface{}, roleNames []string) (*models.User, error)
	}); ok {
...
func (u *UserServiceFacade) Authenticate(email, password string) (*models.User, error) {
	if globalUserService == nil {
		return nil, errors.New("user service not found")
	}
	if userService, ok := globalUserService.(interface {
...
func (u *UserServiceFacade) UpdateProfile(id uint, userData map[string]interface{}) (*models.User, error) {
	if globalUserService == nil {
		return nil, errors.New("user service not found")
	}
	if userService, ok := globalUserService.(interface {
		UpdateUserProfile(id uint, userData map[string]interface{}) (*models.User, error)
	}); ok {
...
func (u *UserServiceFacade) GetWithRoles(id uint) (*models.User, error) {
	if globalUserService == nil {
		return nil, errors.New("user service not found")
	}
	if userService, ok := globalUserService.(interface {
		GetUserWithRoles(id uint) (*models.User, error)
	}); ok {
...
func (u *UserServiceFacade) Search(query string, currentUser *models.User) ([]*models.User, error) {
	if globalUserService == nil {
		return nil, errors.New("user service not found")
	}
	if userService, ok := globalUserService.(interface {
...
func CreateUser(userData map[string]interface{}, roleNames []string) (*models.User, error) {
...
func UpdateUserProfile(id uint, userData map[string]interface{}) (*models.User, error) {
...
func GetUserWithRoles(id uint) (*models.User, error) {
	return User().GetWithRoles(id)
}

// SearchUsers searches users (static helper)
func SearchUsers(query string, currentUser *models.User) ([]*models.User, error) {
