...
func NewServiceDecorator[T any](service BaseServiceInterface[T]) *ServiceDecorator[T] {
...
func NewLoggingDecorator[T any](service BaseServiceInterface[T], logger *log.Logger) *LoggingDecorator[T] {
...
func NewCachingDecorator[T any](service BaseServiceInterface[T], cache CacheInterface, ttl time.Duration) *CachingDecorator[T] {
...
func NewAuditingDecorator[T any](service BaseServiceInterface[T], auditLogger AuditLogger) *AuditingDecorator[T] {
...
type CompositeDecorator[T any] struct {
	*ServiceDecorator[T]
	decorators []BaseServiceInterface[T]
}

// NewCompositeDecorator creates a new composite decorator
func NewCompositeDecorator[T any](service BaseServiceInterface[T], decorators ...BaseServiceInterface[T]) *CompositeDecorator[T] {
