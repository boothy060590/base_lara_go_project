...
type LoggerInterface = app_core.LoggerInterface
type LogDriver = app_core.LogDriver
type LogLevel = app_core.LogLevel

const (
	LogLevelDebug   = app_core.LogLevelDebug
	LogLevelInfo    = app_core.LogLevelInfo
	LogLevelWarning = app_core.LogLevelWarning
	LogLevelError   = app_core.LogLevelError
	LogLevelFatal   = app_core.LogLevelFatal
)
